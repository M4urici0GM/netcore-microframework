...
namespace Microframework.Core
{
    public class HttpServer
    {
            ...
            bool sslEnabled = false)
        {
            ...
            _certificateHandler = new CertificateHandler(_logger, statusService);
        ...
        protected async Task AcceptSocketAsync(CancellationToken cancellationToken)
        {
            ...
            await httpContext.WriteResponseAsJsonAsync(HttpStatusCode.OK, JsonSerializer.Serialize(new {
                message = "Hello World",
            }));
